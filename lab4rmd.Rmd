---
title: "Lab 04 - La Quinta is Spanish for next to Denny's, Eric Fingar"
...
knitr::include_graphics("mitch-hedgeberg-lqd.jpg")
```
...
num_rows <- nrow(states)

# Get the number of columns (variables)
num_cols <- ncol(states)
